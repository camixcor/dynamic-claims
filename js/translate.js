const translations = {
    "en": {
        ...
        "easyClaimList1": "<strong>Free Evaluation:</strong> Begin with a free inspection and consultation.",
        "easyClaimList2": "<strong>Documentation:</strong> We handle all the required paperwork for you.",
        "easyClaimList3": "<strong>Negotiation:</strong> We work directly with your insurance company to maximize your claim.",
        "easyClaimList4": "<strong>Fast Resolution:</strong> Receive your compensation quickly and hassle-free.",
    ...
    "es": {
        ...
        "easyClaimList1": "<strong>Evaluación Gratuita:</strong> Comienza con una inspección y consulta gratuita.",
        "easyClaimList2": "<strong>Documentación:</strong> Nos encargamos de todo el papeleo necesario por ti.",
        "easyClaimList3": "<strong>Negociación:</strong> Trabajamos directamente con tu compañía de seguros para maximizar tu reclamación.",
        "easyClaimList4": "<strong>Resolución Rápida:</strong> Recibe tu compensación de manera rápida y sin complicaciones.",
