const translations = {
    ...
    "part1": "With over 20 years of experience in the insurance claims industry, Herman Machuca is a seasoned professional dedicated to providing top-tier residential and commercial claims consulting services. As the founder of Dynamic Claims Advisors Inc., Herman has built a reputation for excellence, integrity, and unparalleled expertise in handling complex claims.",
        "part2": "Licensed and certified as a PCA/Loss Consultant, Herman combines his deep industry knowledge with a client-focused approach to ensure that every claim is handled efficiently and effectively. Whether you're dealing with property damage, business interruptions, or other insurance-related challenges, Herman’s commitment to delivering results makes him the go-to expert in the field.",
        "part3": "Clients trust Herman for his proven track record, attention to detail, and ability to navigate the intricacies of the claims process. His dedication to fairness and transparency has earned him the respect of both clients and industry peers alike. When you work with Herman Machuca, you’re not just hiring a claims advisor – you’re gaining a partner who will fight for your best interests and ensure you receive the compensation you deserve."
    },
    "es": {
        "home": "Inicio",
...
"part1": "Con más de 20 años de experiencia en el sector de reclamaciones de seguros, Herman Machuca es un profesional altamente capacitado dedicado a ofrecer servicios de consultoría en reclamaciones residenciales y comerciales de primer nivel. Como fundador de Dynamic Claims Advisors Inc., Herman ha construido una reputación basada en la excelencia, la integridad y un conocimiento incomparable en el manejo de reclamaciones complejas.",
        "part2": "Licenciado y certificado como PCA/Consultor de Pérdidas, Herman combina su profundo conocimiento del sector con un enfoque centrado en el cliente para garantizar que cada reclamación se maneje de manera eficiente y efectiva. Ya sea que esté enfrentando daños a la propiedad, interrupciones comerciales u otros desafíos relacionados con seguros, el compromiso de Herman con la obtención de resultados lo convierte en el experto de referencia en el campo.",
        "part3": "Los clientes confían en Herman por su historial comprobado, atención al detalle y capacidad para navegar por las complejidades del proceso de reclamaciones. Su dedicación a la equidad y la transparencia le ha valido el respeto tanto de los clientes como de sus colegas en la industria. Cuando trabaja con Herman Machuca, no solo está contratando a un asesor en reclamaciones, está ganando un aliado que luchará por sus mejores intereses y asegurará que reciba la compensación que merece."
    }
};
